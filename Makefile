...
clean:
	...
	rm -r .eggs || true
	rm -r gabbicompare.egg-info || true

tagv:
	git tag -s \
		-m `python -c 'import gabbicompare; print gabbicompare.__version__'` \
		`python -c 'import gabbicompare; print gabbicompare.__version__'`
